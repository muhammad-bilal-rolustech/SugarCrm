<?php 
 $GLOBALS["dictionary"]["bus_Passenger"]=array (
  'table' => 'bus_passenger',
  'audited' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'bus_passenger_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'bus_passenger_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'bus_passenger_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'bus_passenger_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'bus_passenger_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'bus_passenger_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'bus_passenger_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'bus_passenger_teams',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'bus_passenger_assigned_user',
    ...
    'bus_busmanagment_bus_passenger_name' => 
    array (
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_bus_passenger_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_bus_passenger_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
    ...
    'name_del' => 
    array (
      'name' => 'idx_bus_passenger_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'team_set_bus_passenger' => 
    array (
      'name' => 'idx_bus_passenger_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_bus_passenger_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
