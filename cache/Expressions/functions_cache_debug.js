 ...
 */
SUGAR.FunctionMap = {
	'time'	:	SUGAR.expressions.DefineTimeExpression,	'hourOfDay'	:	SUGAR.expressions.HourOfDayExpression,	'forecastCommitStage'	:	SUGAR.expressions.ForecastCommitStageExpression,	'contains'	:	SUGAR.expressions.ContainsExpression,	'strToLower'	:	SUGAR.expressions.StrToLowerExpression,	'concat'	:	SUGAR.expressions.ConcatenateExpression,	'subStr'	:	SUGAR.expressions.SubStrExpression,	'formatName'	:	SUGAR.expressions.FormatedNameExpression,	'toString'	:	SUGAR.expressions.DefineStringExpression,	'string'	:	SUGAR.expressions.DefineStringExpression,	'charAt'	:	SUGAR.expressions.CharacterAtExpression,	'translateLabel'	:	SUGAR.expressions.SugarTranslateExpression,	'translate'	:	SUGAR.expressions.SugarTranslateExpression,	'strToUpper'	:	SUGAR.expressions.StrToUpperExpression,	'getDropdownValue'	:	SUGAR.expressions.SugarDropDownValueExpression,	'getDDValue'	:	SUGAR.expressions.SugarDropDownValueExpression,	'getListWhere'	:	SUGAR.expressions.SugarListWhereExpression,	'createList'	:	SUGAR.expressions.DefineEnumExpression,	'enum'	:	SUGAR.expressions.DefineEnumExpression,	'getDropdownKeySet'	:	SUGAR.expressions.SugarDropDownExpression,	'getDD'	:	SUGAR.expressions.SugarDropDownExpression,	'forecastSalesStages'	:	SUGAR.expressions.ForecastSalesStageExpression,	'getDropdownValueSet'	:	SUGAR.expressions.SugarTranslatedDropDownExpression,	'getTransDD'	:	SUGAR.expressions.SugarTranslatedDropDownExpression,	'forecastIncludedCommitStages'	:	SUGAR.expressions.ForecastIncludedCommitStagesExpression,	'isInList'	:	SUGAR.expressions.IsInEnumExpression,	'isInEnum'	:	SUGAR.expressions.IsInEnumExpression,	'isValidDBName'	:	SUGAR.expressions.IsValidDBNameExpression,	'isNumeric'	:	SUGAR.expressions.IsNumericExpression,	'isForecastClosedLost'	:	SUGAR.expressions.IsForecastClosedLostExpression,	'not'	:	SUGAR.expressions.NotExpression,	'isAlphaNumeric'	:	SUGAR.expressions.IsAlphaNumericExpression,	'isForecastClosed'	:	SUGAR.expressions.IsForecastClosedExpression,	'isBefore'	:	SUGAR.expressions.isBeforeExpression,	'and'	:	SUGAR.expressions.AndExpression,	'isRequiredCollection'	:	SUGAR.expressions.IsRequiredCollectionExpression,	'isAfter'	:	SUGAR.expressions.isAfterExpression,	'isValidEmail'	:	SUGAR.expressions.IsValidEmailExpression,	'isValidTime'	:	SUGAR.expressions.IsValidTimeExpression,	'greaterThan'	:	SUGAR.expressions.GreaterThanExpression,	'isForecastClosedWon'	:	SUGAR.expressions.IsForecastClosedWonExpression,	'or'	:	SUGAR.expressions.OrExpression,	'equal'	:	SUGAR.expressions.EqualExpression,	'doBothExist'	:	SUGAR.expressions.BinaryDependencyExpression,	'isValidPhone'	:	SUGAR.expressions.IsValidPhoneExpression,	'isWithinRange'	:	SUGAR.expressions.IsInRangeExpression,	'isValidDate'	:	SUGAR.expressions.IsValidDateExpression,	'isAlpha'	:	SUGAR.expressions.IsAlphaExpression,	'rollupConditionalSum'	:	SUGAR.expressions.SumConditionalRelatedExpression,	'strlen'	:	SUGAR.expressions.StringLengthExpression,	'median'	:	SUGAR.expressions.MedianExpression,	'round'	:	SUGAR.expressions.RoundExpression,	'rollupAve'	:	SUGAR.expressions.AverageRelatedExpression,	'rollupAvg'	:	SUGAR.expressions.AverageRelatedExpression,	'ceil'	:	SUGAR.expressions.CeilingExpression,	'ceiling'	:	SUGAR.expressions.CeilingExpression,	'ln'	:	SUGAR.expressions.NaturalLogExpression,	'pow'	:	SUGAR.expressions.PowerExpression,	'rollupMax'	:	SUGAR.expressions.MaxRelatedExpression,	'count'	:	SUGAR.expressions.CountRelatedExpression,	'stddev'	:	SUGAR.expressions.StandardDeviationExpression,	'average'	:	SUGAR.expressions.AverageExpression,	'avg'	:	SUGAR.expressions.AverageExpression,	'min'	:	SUGAR.expressions.MinimumExpression,	'multiply'	:	SUGAR.expressions.MultiplyExpression,	'currencyMultiply'	:	SUGAR.expressions.MultiplyExpression,	'mul'	:	SUGAR.expressions.MultiplyExpression,	'log'	:	SUGAR.expressions.LogExpression,	'negate'	:	SUGAR.expressions.NegateExpression,	'rollupMin'	:	SUGAR.expressions.MinRelatedExpression,	'floor'	:	SUGAR.expressions.FloorExpression,	'subtract'	:	SUGAR.expressions.SubtractExpression,	'currencySubtract'	:	SUGAR.expressions.SubtractExpression,	'sub'	:	SUGAR.expressions.SubtractExpression,	'rollupSum'	:	SUGAR.expressions.SumRelatedExpression,	'rollupCurrencySum'	:	SUGAR.expressions.SumRelatedExpression,	'max'	:	SUGAR.expressions.MaximumExpression,	'number'	:	SUGAR.expressions.ValueOfExpression,	'abs'	:	SUGAR.expressions.AbsoluteValueExpression,	'indexOf'	:	SUGAR.expressions.IndexOfExpression,	'divide'	:	SUGAR.expressions.DivideExpression,	'currencyDivide'	:	SUGAR.expressions.DivideExpression,	'div'	:	SUGAR.expressions.DivideExpression,	'add'	:	SUGAR.expressions.AddExpression,	'currencyAdd'	:	SUGAR.expressions.AddExpression,	'countConditional'	:	SUGAR.expressions.CountConditionalRelatedExpression,	'currencyRate'	:	SUGAR.expressions.CurrencyRateExpression,	'ifElse'	:	SUGAR.expressions.ConditionExpression,	'cond'	:	SUGAR.expressions.ConditionExpression,	'related'	:	SUGAR.expressions.RelatedFieldExpression,	'valueAt'	:	SUGAR.expressions.IndexValueExpression,	'sugarField'	:	SUGAR.expressions.SugarFieldExpression,	'dayofweek'	:	SUGAR.expressions.DayOfWeekExpression,	'timestamp'	:	SUGAR.expressions.TimestampExpression,	'hoursUntil'	:	SUGAR.expressions.HoursUntilExpression,	'maxRelatedDate'	:	SUGAR.expressions.MaxRelatedDateExpression,	'daysUntil'	:	SUGAR.expressions.DaysUntilExpression,	'now'	:	SUGAR.expressions.NowExpression,	'today'	:	SUGAR.expressions.TodayExpression,	'addDays'	:	SUGAR.expressions.AddDaysExpression,	'monthofyear'	:	SUGAR.expressions.MonthOfYearExpression,	'date'	:	SUGAR.expressions.DefineDateExpression};
/**
 * The function to object map that is used by the Parser
 * to parse expressions into objects.
 */
